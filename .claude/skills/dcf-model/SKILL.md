...
**A 股数据获取补充：**
- A 股财务数据可通过 AKShare (`ak.stock_financial_report_sina`) 获取
- A 股折现率参考：无风险利率使用中国10年期国债收益率，股权风险溢价参考 A 股历史数据
- 行业分类使用申万行业分类体系
