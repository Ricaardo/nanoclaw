...
### A 股/港股主题检测
当检测中国市场主题时：
- 使用 AKShare 获取申万行业板块和概念板块数据（替代 FINVIZ）
- 参考东方财富行业/概念板块涨幅排行
- 关注北向资金流入的行业方向
- 中国特色主题：国产替代、新能源、AI算力、中特估等
